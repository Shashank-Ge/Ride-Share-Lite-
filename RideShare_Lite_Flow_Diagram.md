# RideShare Lite - Complete Flow Diagram

This document provides a comprehensive visual overview of the RideShare Lite application architecture, navigation flows, user journeys, and data interactions.
...
## 6. Data Flow - Ride Search & Booking
...
## 10. Feature Flow - My Rides Screen
...
## 14. Key Components & Services

### Context Providers
- **AuthProvider**: Manages authentication state, session handling, sign in/up/out
- **ThemeProvider**: Manages light/dark theme switching and persistence

### Services
- **Supabase Service**: Database client configuration
- **Database Service**: CRUD operations for rides, bookings, profiles, messages
- **Routing Service**: Integration with OpenRouteService for geocoding and route calculation
- **Notification Service**: Push notification setup and handling

### Key Features
1. **Ride Search**: Multi-filter search with sorting options
2. **Ride Publishing**: Driver creates rides with route calculation and stopovers
3. **Booking System**: Instant booking or request-based with driver approval
4. **Chat System**: Real-time messaging between passengers and drivers
5. **My Rides**: Unified view for both passenger bookings and driver-published rides
6. **Profile Management**: Edit profile, verification, privacy settings
7. **Theme System**: Light/dark mode with system preference detection

---

## Summary

RideShare Lite is a comprehensive carpooling application built with:
- **Frontend**: React Native + Expo (cross-platform: iOS, Android, Web)
- **Backend**: Supabase (PostgreSQL database + Authentication)
- **Maps/Routing**: OpenRouteService API
- **Notifications**: Expo Push Notifications
- **Architecture**: Context-based state management, modular navigation, service-oriented design

The app supports two primary user roles (Passenger and Driver) with distinct journeys and features, all unified in a single, theme-aware, mobile-first interface.
